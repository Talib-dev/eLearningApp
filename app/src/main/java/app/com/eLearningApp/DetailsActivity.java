...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private String youtubeDataModel = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youtubeDataModel = getIntent().getStringExtra("DATA");
        Intent intent=getIntent();
        Snippet snippet=intent.getParcelableExtra("DATAOBJ");
        if (youtubeDataModel!=null){
            Data=youtubeDataModel.split("%");
        }
    ...
    if (youtubeDataModel!=null){
        ...
        textViewDes.setText(Data[1]);
        String[] date = Data[2].split("T");
        textViewDate.setText(date[1]);}
...
//    }
    ...
    private void initList() {
        ...
        adapter = new VideoPostAdapter(getApplicationContext(), mList);
